...
DocumentArrayPath.prototype.cast = function(value, doc, init, prev, options) {
  ...
  const castEnded = Date.now();
  if (castEnded - castStarted > 10000) {
    console.log('documentarray.cast takes more than 10 secs!');
    console.log('value:', value, 'doc:', doc, 'init:', init, 'prev:', prev, 'options:', options);
  } 
  return value;
};
